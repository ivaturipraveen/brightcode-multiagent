...
export function ChatSidebar({
  ...
  return (
    <aside className="flex h-screen w-72 flex-shrink-0 flex-col border-r border-gray-100 bg-white">
      {/* Logo / App name */}
      <div className="flex items-center gap-2.5 border-b border-gray-100 px-5 py-4">
        ...
        <span className="text-sm font-semibold text-gray-900">OpenClaw Chat</span>
      </div>
      ...
      <div className="px-3 pt-4">
        <button
          onClick={onNewChat}
          className="flex w-full items-center gap-2 rounded-xl border border-dashed border-gray-200 bg-gray-50 px-3.5 py-2.5 text-sm font-medium text-gray-500 transition hover:border-indigo-300 hover:bg-indigo-50 hover:text-indigo-600"
        >
            ...
            {conversations.map((conversation) => {
              ...
              return (
                ...
                >
                  ...
                  <span className={`mt-0.5 text-xs ${active ? 'text-indigo-400' : 'text-gray-400'}`}>
      ...
      <button
        ...
        className="flex items-center gap-3 border-t border-gray-100 px-4 py-3.5 transition hover:bg-gray-50"
      >
        {profile.avatar_url ? (
          <img
